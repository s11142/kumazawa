...
#define AUTO
#ifdef AUTO
#define M_START     (9.0e-4)	//熱交換流体の質量の下限値
#define M_END       (1.0e-2)	//熱交換流体の質量の上限値
#define DM          (5.0e-4)	//熱交換流体の質量の変化幅
#endif

#define T_HIGH         (47.0)    //high end[K]
#define T_LOW          (23.0)    //low  end[K]
...
//Temp[K]	density[kg/m3]	Cp[J/kg-K]	viscosity[kg/m-s]	k[W/m-K]=[J/m-K-s]
	...
	fp_entropy[1] = fopen("LaAl2_kg_HoAl2_select_0.05-6T/C_Tc=30K_Ho3+_0.05-6T_LaAl2.txt", "r");	/* ※ */
